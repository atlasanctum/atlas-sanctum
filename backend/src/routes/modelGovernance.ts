 ...
 */
router.post('/:modelId/register', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/:modelId/audit', async (req: Request, res: Response) => {
  try {
    const modelId = req.params.modelId as string;
 ...
 */
router.post('/:modelId/drift', async (req: Request, res: Response) => {
  try {
    const modelId = req.params.modelId as string;
 ...
 */
router.get('/:modelId/report', async (req: Request, res: Response) => {
  try {
    const modelId = req.params.modelId as string;
